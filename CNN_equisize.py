...
training_set = train_datagen.flow_from_directory('ExperimentDataSet/Sampled_data/TrainingData', # Path to the target directory. It should contain one subdirectory per class.
target_size = (64, 64),
batch_size = 25,
class_mode = 'binary')

print (5)
test_set = test_datagen.flow_from_directory('ExperimentDataSet/Sampled_data/ValidationData',
target_size = (64, 64),
...
steps_per_epoch = 366,#Total number of steps (batches of samples) to yield from generator before declaring one epoch finished and starting the next epoch
epochs = 25,
...
score = classifier.evaluate_generator(test_set, 72, workers=1)
scores = classifier.predict_generator(test_set, 72, workers=1)
correct = 0
#
#print (score)
#print (scores)
